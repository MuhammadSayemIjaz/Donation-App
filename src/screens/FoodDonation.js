...
const FoodDonation = () => {
     ...
     const handleSubmit = async () => {
          ...
          const storageRef = ref(storage, 'Food Items Images/' + Date.now());
          ...
          <SafeAreaView style={styles.container}>
               ...
               <View style={styles.subContainer}>
                    <View style={styles.headerContainer}>
                         ...
                         <Text style={styles.heading}>Food Donation</Text>
                    </View>
                                        ...
                                        <TouchableOpacity activeOpacity={0.5} style={{ width: '100%', height: '100%' }} onPress={handlePickImage} >
                                             {isImageSelected ?
                                                  ...
                                                  <View style={styles.inactiveImageContainer}>
                                                       ...
                                                       <Text style={{ fontSize: 20, lineHeight: 30, color: Color.textPrimary, letterSpacing: 1, textAlign: 'center' }}>Upload Food Items Image</Text>
