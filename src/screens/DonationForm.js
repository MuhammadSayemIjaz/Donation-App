...
const DonationForm = () => {
     ...
     const handleSubmit = async () => {
          ...
          //           setIsLoading(false)
          //      });
          console.log(isImageSelected, backImage);
     };
     return (
          <SafeAreaView style={styles.container}>
               <StatusBar backgroundColor='transparent' translucent={false} style='light' />
                         ...
                         <View style={styles.header}>
                              ...
                              <View style={styles.content}>
                                   <View style={styles.imageContainer}>
                                        <TouchableOpacity activeOpacity={0.5} style={{ width: '100%', height: '100%' }} onPress={() => handlePickImage('front')} >
                                             {isImageSelected ?
                                                  ...
                                                  <View style={styles.inactiveImageContainer}>
                                                       ...
                                                       <Text style={{ fontSize: 20, color: Color.textPrimary, letterSpacing: 1 }}>CNIC Front</Text>
                                   ...
                                   <View style={styles.imageContainer}>
                                        <TouchableOpacity activeOpacity={0.5} style={{ width: '100%', height: '100%' }} onPress={() => handlePickImage('back')} >
                                             {backImage ?
                                                  <View style={[styles.activeImageContainer, { elevation: 2, borderRadius: 20 }]}>
                                                       <Image style={styles.image} source={{ uri: backImage }} resizeMode='contain' />
                                                  </View>
                                                  :
                                                  <View style={styles.inactiveImageContainer}>
                                                       <Feather name="image" size={54} color={Color.primary} />
                                                       <Text style={{ fontSize: 20, color: Color.textPrimary, letterSpacing: 1 }}>CNIC Back</Text>
                                                       {/* <FontAwesome name="user-circle-o" size={154}  /> */}
                                                  </View>
                                             }
                                        </TouchableOpacity>
